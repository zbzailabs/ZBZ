---
title: "بعد أن أعدت تثبيت OpenClaw خمس مرات، كتبت أخيرًا الإعدادات التي ينبغي للمبتدئ أن ينسخها كما هي"
description: "أعدت تثبيت OpenClaw خمس مرات على جهاز Mac جديد، وفي النهاية اتضحت لي أكثر الحفر التي يقع فيها الناس: ما الذي يجب ضبطه أولًا في Node وpnpm وSSH وFeishu وتعدد الوكلاء وQMD وACP، وما الذي يبدو سليمًا في البداية لكنه ينفجر لاحقًا. هذه المقالة تجمع كل ذلك في مكان واحد."
category: "startup"
tags:
  - "allocation"
  - "strategy"
...
heroImageAlt: "صورة غلاف لدليل إعداد وتثبيت OpenClaw على جهاز Mac جديد"
heroImageWidth: 2400
...
# بعد أن أعدت تثبيت OpenClaw خمس مرات، كتبت أخيرًا الإعدادات التي ينبغي للمبتدئ أن ينسخها كما هي
