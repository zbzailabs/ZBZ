---
title: "OpenClaw를 5번 재설치하고 나서야 초보자가 그대로 베껴야 할 설정을 전부 적어뒀다"
description: "새 Mac에서 OpenClaw를 다섯 번 다시 설치한 끝에, 어디서 가장 많이 삐끗하는지 확실히 정리했다. Node, pnpm, SSH, Feishu, 멀티 에이전트, QMD, ACP 중 무엇을 먼저 잡아야 하는지, 그리고 겉으로는 멀쩡해 보여도 결국 터지는 설정이 무엇인지 이 글 한 편에 담았다."
category: "startup"
tags:
  - "allocation"
  - "strategy"
...
heroImageAlt: "새 Mac에서 OpenClaw 설치 및 설정 가이드를 위한 커버 이미지"
heroImageWidth: 2400
...
# OpenClaw를 5번 재설치하고 나서야 초보자가 그대로 베껴야 할 설정을 전부 적어뒀다
